...
const StudentList = () => {
    ...
    const onSubmit = (e) => {
       e.preventDefault();
       axios.get("http://localhost:8888/authentification/student/keyword/"+search,  {
        headers: {
          Authorization:
            "Bearer " +
            JSON.parse(localStorage.getItem("user_data")).accessToken,
                ...
                <CardHeader className="border-0">
                  <Container>
                    <Row>
                      ...
                      <Col>
                        <Form onSubmit={onSubmit} className="navbar-search navbar-search-light form-inline mr-3 d-none d-md-flex ml-lg-auto">
                      ...
                      <tr>
                        <th scope="row">
                          <Media className="align-items-center">
                            ...
                            <Media>
                              <span className="mb-0 text-sm">{student.firstName} {student.lastName}</span>
                            </Media>
                          </Media>
                        </th>
